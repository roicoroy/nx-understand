...
export interface PluginGoogleAuthMobileCredential
  extends Schema.CollectionType {
  collectionName: 'google-auth-mobile_credential';
  info: {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::google-auth-mobile.credential',
      'oneToOne',
      'admin::user'
    >;
    updatedBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::google-auth-mobile.credential': PluginGoogleAuthMobileCredential;
    }
  }
}
